...
All legacy commands/docs assume you run them from the `legacy/` directory. From
the repo root, `cd legacy` first.
...
These are enforced through prompt policies + orchestration rules + post-generation validators (see `docs/legacy/SAFETY.md`).
...
Details: `docs/legacy/WEB_GROUNDING.md`
...
2. **`docs/legacy/REQUIREMENTS.md`** — source of truth for features and constraints  
3. **`docs/legacy/ARCHITECTURE.md`** — modules + orchestration flows + context payload contract  
4. **`docs/legacy/DATA_MODEL.md`** — tables for sessions, KG, epistemics, grounding, events  
5. **`docs/legacy/API.md`** — endpoints + streaming + tier gating  
6. **`docs/legacy/SAFETY.md`** — guardrails + “unknown stays unknown” + Standard no-coaching validator  
7. **`docs/legacy/WEB_GROUNDING.md`** — Tavily pipeline + budgets + schemas  
8. **`docs/legacy/TEMPLATES.md`** + **`docs/legacy/ADMIN_REVIEW.md`** — template library + draft/review workflow  
9. **`docs/legacy/EVENTS.md`** — telemetry/event taxonomy (consent-aware)
...
- `docs/legacy/REQUIREMENTS.md` — product requirements (v0.1)
- `docs/legacy/ARCHITECTURE.md` — system design + orchestration
- `docs/legacy/DATA_MODEL.md` — KG + epistemics + grounding + event sourcing
- `docs/legacy/WEB_GROUNDING.md` — Tavily search RAG design
- `docs/legacy/API.md` — API contract outline
- `docs/legacy/SAFETY.md` — safety + Standard vs Premium guardrails
- `docs/legacy/TEMPLATES.md` — templates + “Other” + draft workflow
- `docs/legacy/ADMIN_REVIEW.md` — human review process for templates
- `docs/legacy/EVENTS.md` — telemetry & training signals
- `docs/legacy/DEPENDENCIES.md` — package choices + licensing notes
- `docs/legacy/SETUP.md` — developer setup
